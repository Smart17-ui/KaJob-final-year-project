...
const Notifications = () => {
  ...
  const handleCancelDelete = () => {
    if (isDeletingAll || deletingId !== null) {
      return;
    }
  ...
  const handleConfirmDelete = () => {
    if (
      ...
      confirmationModal.notificationId !== null
    ) {
      void handleDelete(
        confirmationModal.notificationId
      );

      return;
    }

    if (confirmationModal.type === "all") {
